    ...
    <Shell>
      <div className="px-[30px] py-[26px] pb-[30px] max-md:px-4 max-md:py-5">
        <div className="flex items-center justify-between mb-[22px] flex-wrap gap-3">
          <span className="text-white text-[28px] font-extrabold tracking-[-0.5px] max-md:text-[24px]">
        ...
        <div className="grid grid-cols-4 gap-4 mb-5 max-lg:grid-cols-2">
          {kpis.map((k) => (
            <div key={k.label} className="bg-card border border-borderCard rounded-[14px] p-[18px_20px]">
              ...
              <div className="text-white text-[32px] font-extrabold tracking-[-1px] max-md:text-[26px]">{k.value}</div>
            </div>
          ))}
        </div>

        <div className="grid grid-cols-[1.55fr_1fr] gap-[18px] mb-5 max-lg:grid-cols-1">
          <div className="bg-card border border-borderCard rounded-[14px] p-[20px_22px]">
            ...
            <div className="flex gap-[18px] max-md:flex-col">
              ...
              <div className="flex flex-col gap-[11px] justify-center max-md:flex-row max-md:flex-wrap max-md:gap-4">
                {areaLegend.map((l) => (
        ...
        <div className="grid grid-cols-[1.55fr_1fr] gap-[18px] max-lg:grid-cols-1">
          <div className="bg-card border border-borderCard rounded-[14px] p-[20px_22px]">
